...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    <main class="min-h-screen pt-24 pb-16 bg-[var(--bg-primary)]">
      <div class="container mx-auto px-4">
        ...
        <div class="mb-10 text-center">
          <h1 class="text-4xl font-heading font-bold mb-4">Hoodies</h1>
          <p class="text-[var(--text-secondary)]">Explore our premium collection of hoodies.</p>
        </div>
  ...
  try {
    ...
    currentFiltered = allProducts.filter(p => p.category === 'hoodie');
